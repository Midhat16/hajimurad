    ...
    >
      ...
      >
        ...
        <div className="p-4 flex items-center justify-center bg-white">
          <span className="text-sm font-extrabold uppercase tracking-wider text-[var(--ink)] bg-[var(--fog)] px-4 py-2 border border-[var(--line)] text-center">
            {report.year || "Annual Audit"}
          </span>
        </div>
      </a>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        {loading ? (
          <div className="bg-white rounded-none p-16 text-center border border-[var(--line)] shadow-sm max-w-md mx-auto">
            ...
            <p className="text-xs font-extrabold text-[var(--ink)] uppercase tracking-wider">Loading Annual Reports...</p>
          </div>
        ) : reports.length === 0 ? (
          <div className="bg-white rounded-none p-12 text-center border border-[var(--line)] shadow-sm space-y-3 max-w-lg mx-auto">
            ...
            <h3 className="text-lg font-extrabold text-[var(--ink)]">No Annual Reports Published Yet</h3>
