    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[var(--line)] pb-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <Link
            ...
            className="inline-flex items-center gap-2 bg-[var(--fog)] text-[#2B1F1A] hover:bg-slate-200 px-4 py-2.5 rounded-xl text-xs font-bold border border-[var(--line)] transition-all cursor-pointer shadow-xs"
          >
      ...
      {loading ? (
        <div className="bg-white rounded-3xl p-12 text-center border border-[var(--line)]">
          ...
          <p className="text-xs font-bold text-[#2B1F1A] uppercase">Loading Internships...</p>
        </div>
      ) : internships.length === 0 ? (
        <div className="bg-white rounded-3xl p-12 text-center border border-[var(--line)] space-y-4">
          <GraduationCap className="w-12 h-12 text-slate-300 mx-auto" />
          <h3 className="text-base font-extrabold text-[#2B1F1A]">No Internship Programs Found</h3>
          ...
          {internships.map((program) => (
            ...
            >
              <div className="p-5 space-y-3">
                ...
                <h3 className="text-lg font-extrabold text-[#2B1F1A] leading-snug">
                  {program.title}
                </h3>
              ...
              <div className="p-4 bg-[var(--fog)] border-t border-[var(--line)]/60 flex items-center justify-between gap-2">
                <Link
                  ...
                  target="_blank"
                  className="p-2 text-slate-500 hover:text-[#2B1F1A] rounded-lg hover:bg-white transition-colors"
                ...
                <div className="flex items-center gap-2">
                  <Link
                    ...
                    className="flex items-center gap-1.5 bg-white border border-slate-200 hover:border-slate-300 px-3 py-1.5 rounded-xl text-xs font-bold text-[#2B1F1A] transition-all cursor-pointer shadow-xs"
                  >
