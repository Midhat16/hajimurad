        ...
        <div className="space-y-3 border-t border-slate-100 pt-5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs font-bold text-[var(--iris)] hover:text-[var(--ink)] transition-colors cursor-pointer"
            >
            ...
            {formData.features.map((feat, idx) => (
              <div key={idx} className="flex items-center gap-2">
                ...
                <input
                  ...
                  placeholder=""
                  className="flex-1 bg-[var(--fog)] border border-[var(--line)] focus:border-[var(--iris)] focus:ring-[var(--iris)]/20 rounded-xl px-4 py-2.5 text-xs text-[var(--ink)] font-semibold focus:outline-none focus:ring-4 transition-all"
                />
