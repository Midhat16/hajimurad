...
import MessageSidebarStickyWrapper from "./MessageSidebarStickyWrapper";
...
export default function HospitalMessageClient() {
  ...
  return (
    <main className="min-h-screen bg-[var(--fog)] pb-4 sm:pb-6 font-sans">
      {/* Top Hero Banner */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-9 space-y-8 mb-2 sm:mb-4">
            {loading ? (
              ...
              <>
                ...
                <motion.section
                  ...
                  className="bg-white rounded-3xl p-6 sm:p-10 border border-[var(--line)] shadow-xl relative overflow-hidden space-y-8 scroll-mt-28 mb-[10px]"
                >
