      ...
      >
        ...
        <div className="relative w-full aspect-[3/4] bg-slate-100 border-b border-slate-100 overflow-hidden flex items-center justify-center">
          {showCover ? (
            ...
            <div className="w-full h-full bg-[#0F172A] p-6 flex flex-col items-center justify-center text-center text-white relative overflow-hidden">
        ...
        <div className="p-4 flex items-center justify-center bg-white">
          <span className="text-sm font-extrabold uppercase tracking-wider text-[#2B1F1A] bg-[var(--fog)] px-4 py-2 border border-[var(--line)] text-center flex items-center gap-2">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        {loading ? (
          <div className="bg-white rounded-none p-16 text-center border border-[var(--line)] shadow-sm max-w-md mx-auto">
            ...
            <p className="text-xs font-extrabold text-[#2B1F1A] uppercase tracking-wider">Loading Newsletters...</p>
          </div>
          ...
          <div className="bg-white rounded-none p-12 text-center border border-[var(--line)] shadow-sm space-y-3 max-w-lg mx-auto">
            ...
            <h3 className="text-lg font-extrabold text-[#2B1F1A]">No Newsletters Published Yet</h3>
