            ...
            {submittedSuccess ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl bg-[#C4232C] hover:bg-[#a81c24] hover:opacity-95 text-white text-xs font-extrabold shadow-md flex items-center justify-center gap-2 cursor-pointer transition-all disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
...
export default function ApplyFormClient() {
  return (
    <main className="min-h-screen bg-[var(--fog)] py-8 font-sans">
      <Suspense
        fallback={
          <div className="min-h-[60vh] flex items-center justify-center">
            <div className="bg-white rounded-3xl p-12 text-center border border-[var(--line)] shadow-sm">
