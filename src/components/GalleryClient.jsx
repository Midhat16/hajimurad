...
import { Image as ImageIcon, Sparkles, X, Check, Camera } from "lucide-react";
...
const DEFAULT_GALLERY_IMAGES = [
  ...
  },
  {
    ...
    title: "Haji Murad Eye Hospital Trust Campus",
...
export default function GalleryClient() {
  ...
  return (
    <main className="min-h-screen bg-[var(--fog)] pb-0 font-sans">
      ...
      <section className="bg-[#1E1433] text-white py-6 sm:py-8 px-4 sm:px-6 lg:px-8 relative overflow-hidden mb-6 shadow-md">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center space-y-4">
          <span className="inline-flex items-center gap-2 text-[11px] font-extrabold uppercase tracking-widest text-[#5EEAD4] bg-white/10 px-4 py-1.5 rounded-full border border-white/10">
            <Camera className="w-4 h-4" /> Photo Gallery & Moments
          </span>
            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`px-4.5 py-1.5 rounded-full text-xs font-extrabold transition-all cursor-pointer ${isActive
                      ? "bg-white text-[var(--ink)] shadow-md scale-105"
      ...
      {/* Main Content Body */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-[10px]">
        {loading ? (
          ...
          <div className="py-24 text-center bg-white/60 backdrop-blur-md rounded-3xl border border-white/40 shadow-sm max-w-md mx-auto p-8 mb-[10px]">
          ...
          <div className="w-full mb-[10px]">
            <RowsPhotoAlbum
              ...
              componentsProps={{
                wrapper: {
                  className: "group relative shadow-md hover:shadow-2xl transition-all duration-300 border border-white/20 bg-slate-900 mb-[15px]",
                  style: {
            ...
            <div className="max-w-5xl w-full space-y-4 text-center">
              <div className="relative aspect-video max-h-[75vh] mx-auto rounded-3xl overflow-hidden shadow-2xl border border-white/20 bg-black flex items-center justify-center">
                <NextImage
                  ...
                  alt={selectedImage.title || selectedImage.caption || `${selectedImage.category || "Hospital Gallery"} Photo - Haji Murad Eye Hospital Trust`}
                  width={1200}
                  height={800}
                  loading="lazy"
                  decoding="async"
