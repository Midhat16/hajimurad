            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* 1. FRONT SIDE */}
                  <div
                    className="absolute inset-0 w-full h-full rounded-[28px] p-5 sm:p-6 glass-card bg-white flex flex-col justify-between border border-[var(--line)] shadow-xs"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center mt-1 flex-1 justify-start">
                      <div className="relative w-22 h-22 sm:w-24 sm:h-24 rounded-full p-1 bg-gradient-to-tr from-[var(--ink)]/30 to-[var(--iris)]/30 shadow-sm flex-shrink-0">
                        ...
                        <div className="absolute bottom-0 right-0 bg-white p-1 rounded-full border border-[var(--line)] shadow-md text-[var(--ink)] z-10">
                          <Stethoscope className="w-3.5 h-3.5" />
                        </div>
                      </div>

                      <h3 className="mt-3 text-lg sm:text-xl font-bold text-[var(--ink)] text-center leading-tight">
                        {doctor.name}
                      </h3>
                    ...
                    <div className="border-t border-[var(--line)] pt-2 flex flex-col gap-1 h-[105px] flex-shrink-0 w-full min-w-0 justify-start">
                      ...
                      <div className="h-5 flex items-center justify-center w-full min-w-0">
                        <div className={`flex items-center gap-1.5 text-[11px] font-bold justify-center w-full min-w-0 ${
                      ...
                      <div className="h-6 flex items-center justify-center w-full min-w-0">
                        {doctor.pmdcNo && (
                          <div className="w-full text-[10px] font-bold text-[var(--ink)] bg-[var(--fog)] py-0.5 px-2 rounded-md text-center border border-[var(--line)]">
                  ...
                  <div
                    className="absolute inset-0 w-full h-full rounded-[32px] p-6 bg-gradient-to-b from-[var(--ink)] via-[#1F1612] to-[var(--ink)] flex flex-col justify-between text-white border border-[var(--ink)] shadow-xl overflow-y-auto"
                    style={{
                      backfaceVisibility: "hidden",
                      WebkitBackfaceVisibility: "hidden",
                  ...
                  >
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="text-[10px] text-[var(--iris)] font-bold tracking-wider">{toTitleCase(doctor.specialty || doctor.role)}</p>
                        {doctor.pmdcNo && (
                          <p className="text-[10px] text-slate-300 font-semibold mt-0.5">PMDC #: {doctor.pmdcNo}</p>
                        )}
                      </div>

                      <div className={`p-2 rounded-xl border text-xs font-bold flex items-center gap-1.5 ${
                        scheduleDisplay === "Schedule not set"
                          ? "bg-white/5 border-white/10 text-slate-400 italic"
                          : "bg-white/10 border-white/15 text-emerald-300"
                      }`}>
                        <Calendar className="w-3.5 h-3.5 flex-shrink-0" />
                        <span>Availability: {scheduleDisplay}</span>
                      </div>
                    ...
                    <a
                      ...
                      className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[var(--ink)] to-[var(--iris)] text-white py-2.5 rounded-xl text-xs font-bold shadow-md hover:opacity-95 transition-opacity mt-2 cursor-pointer"
                    >
